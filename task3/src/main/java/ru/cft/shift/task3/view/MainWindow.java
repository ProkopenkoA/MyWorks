...
public class MainWindow extends JFrame implements FieldListener, SecondListener {
    ...
    @Override
    public void createNewGameField(int length, int width, int numberOfMine) {
        createGameField(length, width);
        setTimerValue(0);
    ...
    public void setSecond(int second) {
        setTimerValue(second);
    }

    @Override
    public void changeMineCount(int numberOfMine) {
        setBombsCount(numberOfMine);
    }
}
